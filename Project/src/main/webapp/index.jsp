...
<body>
	...
	<div class="welcome-container text-center">
		...
		<div>
			...
			<a href="./Proyecto/signup.jsp?accion=insertar" class="btn btn-custom">Sign Up</a>
		</div>
	</div>
	...
	<div id="loginPopup">
		...
		<form action="/Project/LogInServlet" method="post">
			<div class="form-group">
				<label for="nameUsuario">Usuario:</label> <input type="text"
					class="form-control" name="nameUsuario" id="nameUsuario">
			</div>
			<div class="form-group">
